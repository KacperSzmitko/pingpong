...
protected:
	...
	sf::Vector2f calcRealVector(const sf::Vector2f &pixelPos);
	sf::Vector2f calcRealVector(const sf::Vector2i &pixelPos);
	sf::Vector2f calcPixelVector(const sf::Vector2f &realPos);
